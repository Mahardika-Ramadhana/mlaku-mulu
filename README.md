...
3.  **Akses Mandiri Turis**:
    ...
    *   Turis dapat melihat riwayat perjalanan mereka sendiri dengan field response yang sesuai spesifikasi:
        *   `tanggalMulaiPerjalanan` (format UTC ISO 8601 beserta jam)
        *   `tanggalBerakhirPerjalanan` (format UTC ISO 8601 beserta jam)
        *   `destinasiPerjalanan` (dapat berupa string atau JSON object/array)
4.  **Validasi Otomatis & Dokumentasi**:
...
5.  **Pengujian Komprehensif (E2E & Unit)**:
    *   Terdapat 16 test cases di pengujian E2E yang mencakup seluruh alur utama sistem.
